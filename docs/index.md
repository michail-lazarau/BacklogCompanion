...
- **[Jest Test Infrastructure](jest-test-infrastructure.md)**: Known test leaks (redux-persist, TanStack Query), fixes applied, and the pattern to follow for new test files.
